...
public class TableMaker
{
    ...
    private void init()
    {
        ...
        fields.Add(item: new ColumnDef() { name = "CreatedBy", type = "varchar", size = 20, nully = "NULL" });
        fields.Add(item: new ColumnDef() { name = "EditedOn", type = "DateTime2", nully = "NULL" });
        fields.Add(item: new ColumnDef() { name = "EditedBy", type = "varchar", size = 20, nully = "NULL" });
        fields.Add(item: new ColumnDef() { name = "DeletedOn", type = "DateTime2", nully = "NULL" });
        fields.Add(item: new ColumnDef() { name = "DeletedBy", type = "varchar", size = 20, nully = "NULL" });
    }
    ...
    public override string ToString()
    {
        ...
        {
            ColumnDef name = new ColumnDef(){name = "Name", type = "varchar", size = 50, nully = "NOT NULL" };
            this.fields.Insert(0, name);            
            ColumnDef code = new ColumnDef(){name = "Code", type = "varchar", size = 10, nully = "NULL" };
